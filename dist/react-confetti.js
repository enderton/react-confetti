...
var Particle = /*#__PURE__*/function () {
  function Particle(context, getOptions, x, y) {
    ...
    _defineProperty(this, "drawShape", void 0);
    ...
    var _this$getOptions = this.getOptions(),
        ...
        drawShapes = _this$getOptions.drawShapes,
    ...
    if (drawShapes && Array.isArray(drawShapes)) {
      this.drawShape = drawShapes[Object(_utils__WEBPACK_IMPORTED_MODULE_0__["randomInt"])(0, drawShapes.length - 1)];
    }
  }
...
function extractCanvasProps(props) {
  ...
  var refs = {};
  var rest = {};
  var confettiOptionKeys = [].concat(_toConsumableArray(Object.keys(_Confetti__WEBPACK_IMPORTED_MODULE_1__["confettiDefaults"])), ['confettiSource', 'drawShapes', 'onConfettiComplete']);
